...
describe('getPeriod: Obtaining the period to apply at a given time', () => {
  ...
  describe('Given a highpower tariff in the peninsula', () => {
    test('Labour day before 8:00 should return valley', () => {
      expect(getPeriod(labour_07_30, 'Taula_Peatges_30_60_Peninsular')).toBe(
        'P6',
      )
    })
    test('Labour day before 10:00 should return flat', () => {
      expect(getPeriod(labour_08_30, 'Taula_Peatges_30_60_Peninsular')).toBe(
        'P2',
      )
    })
    test('Labour day before 14:00 should return peak', () => {
      expect(getPeriod(labour_09_30, 'Taula_Peatges_30_60_Peninsular')).toBe(
        'P1',
      )
      expect(getPeriod(labour_11_30, 'Taula_Peatges_30_60_Peninsular')).toBe(
        'P1',
      )
    })
    test('Labour day before 18:00 should return flat', () => {
      expect(getPeriod(labour_14_30, 'Taula_Peatges_30_60_Peninsular')).toBe(
        'P2',
      )
      expect(getPeriod(labour_15_30, 'Taula_Peatges_30_60_Peninsular')).toBe(
        'P2',
      )
    })
    test('Labour day before 22:00 should return peak', () => {
      expect(getPeriod(labour_18_30, 'Taula_Peatges_30_60_Peninsular')).toBe(
        'P1',
      )
    })
    test('Labour day after 22:00 should return flat', () => {
      expect(getPeriod(labour_22_30, 'Taula_Peatges_30_60_Peninsular')).toBe(
        'P2',
      )
    })
    test('Weekend day any time should return valley', () => {
      expect(getPeriod(weekend_11_30, 'Taula_Peatges_30_60_Peninsular')).toBe(
        'P6',
      )
    })
    test('Holiday day any time should return valley', () => {
      expect(getPeriod(holiday_11_30, 'Taula_Peatges_30_60_Peninsular')).toBe(
        'P6',
      )
    })
  })
  ...
  describe('Given a highpower tariff in the Canary Islands', () => {
    ...
    test('Weekend day any time should return valley', () => {
      expect(getPeriod(weekend_11_30, 'Taula_Peatges_30_60_Canaries')).toBe(
        'P6',
      )
    })
    test('Holiday day any time should return valley', () => {
      expect(getPeriod(holiday_11_30, 'Taula_Peatges_30_60_Canaries')).toBe(
        'P6',
      )
    })
  })
  describe('Given a high power tariff month changes season', () => {
    test('Labour day before 8:00 should return valley', () => {
      ...
      expect(
        getPeriod(labour_08_30_july, 'Taula_Peatges_30_60_Peninsular'),
      ).toBe('P2')
      expect(getPeriod(labour_08_30_july, 'Taula_Peatges_30_60_Canaries')).toBe(
        'P3',
      )
      expect(getPeriod(labour_08_30_july, 'Taula_Peatges_30_60_Balears')).toBe(
        'P2',
      )
    })
  })
