...
import { BarChart, ResponsiveContainer, CartesianGrid, XAxis, YAxis, Tooltip, Bar, Cell, Label } from 'recharts'
    ...
    <div style={{ height: '300px' }}>
      <ResponsiveContainer>
        <BarChart width={730} height={250} data={data}>
          ...
          <YAxis axisLine={false} tickCount={6} tickLine={false} tickFormatter={(tickItem) => `${formatNumber(tickItem)}`} tick={{ transform: 'translate(-2, 0)' }}>ç
